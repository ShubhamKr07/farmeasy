...
import { buildPoolConfig } from "../src/ssl.ts";
...
const { Pool } = pg;
// buildPoolConfig strips any `sslmode` from the URL and pins the CA — pg would
// otherwise silently ignore the ssl object (see ../src/ssl.ts, 2026-08-10).
